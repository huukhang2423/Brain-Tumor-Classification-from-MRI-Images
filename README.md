...
```bibtex
@misc{brain_tumor_svm,
  author = {Your Name},
  title = {Brain Tumor Classification using SVM},
  year = {2024},
  publisher = {GitHub},
...
⚠️ **Medical Disclaimer**: This system is for **research and educational purposes only**. It is NOT approved for clinical diagnosis. Always consult qualified healthcare professionals for medical decisions.
